...
from thyroid.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformArtifact,ModelTrainerArtifact,ModelEvulationArtifact
...
from thyroid.components.model_evulation import ModelEvulation
